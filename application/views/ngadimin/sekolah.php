    ...
    <div class="row layout-top-spacing" id="cancel-row">
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <div class="widget-content widget-content-area br-6">
                <a href="javascript:;" id="btn-add-sekolah" class="btn btn-primary">Tambah Baru</a>
...
<div class="modal fade" id="addSekolahModal" tabindex="-1" role="dialog" aria-labelledby="addSekolahModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form id="addSekolahModalTitle" method="post" action="<?= base_url('ngadimin/sekolah/do_insert') ?>">
...
<script src="<?= base_url('assets/js/ngadimin/sekolah.js') ?>"></script>