...
<div class="modal fade" id="addUserModal" tabindex="-1" role="dialog" aria-labelledby="addUserModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form id="addUserModalTitle" method="post" action="<?= base_url('admin/guru/do_insert') ?>">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" id="username" name="username" class="form-control" placeholder="NUPTK">
                                    </div>
                                    <div class="form-group">
...
<script src="<?= base_url('assets/js/admin/guru.js') ?>"></script>